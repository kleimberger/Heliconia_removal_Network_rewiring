...
ggplot2::ggsave("../../results/network_visualizations/metanetworks/Pollen_and_camera_metanetworks_multiplot.png", network_multiplot, width = 10, height = 18, dpi = 600, units = "in", bg = "white")
```
