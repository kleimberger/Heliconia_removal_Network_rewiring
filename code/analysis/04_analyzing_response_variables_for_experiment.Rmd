...
contrast_plot_individual <- contrasts_of_contrasts_df %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "subanalysis", shading = "above", text_size = size, title_size = title_size, point_size = shape_size, line_size = line_width) +
    ...
    annotation_custom(rasterGrob(pollen_icon, width = 0.4), xmin = 1, xmax = 2, ymin = 3.5*1.55, ymax = Inf) +
    ...
    annotate("text",  x = 3.6, y = 2.25, size = size*0.35, angle = 0, color = "black", label = c("Pre-to-post \ndecrease in specialization \nrelative to controls")) +
    annotate("text",  x = 3.6, y = 0.4, size = size*0.35, angle = 0, color = "black", label = c("Pre-to-post \nincrease in specialization \nrelative to controls"))

ggview(contrast_plot_individual, units = "mm", width = column2x*0.66, height = column2x*0.5)
ggsave(file.path(path_name, "Fig4.png"), contrast_plot_individual, width = column2x*0.66, height = column2x*0.5, units = "mm", bg = "white", device = "tiff", dpi = 600)
```
...
contrast_plot_turnover <- contrasts_of_contrasts_df %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "yvar", shading = "above", text_size = size, title_size = title_size, point_size = shape_size, line_size = line_width) +
    ...
    annotation_custom(rasterGrob(camera_icon, width = 0.3), xmin = 1, xmax = 3, ymin = 2.5*1.55, ymax = Inf) +
    ...
    annotate("text",  x = 4.9, y = 1.75, size = size*0.35, angle = 0, color = "black", label = c("Pre-to-post \nincrease in turnover \nrelative to controls")) +
    annotate("text",  x = 4.9, y = 0.4, size = size*0.35, angle = 0, color = "black", label = c("Pre-to-post \ndecrease in turnover \nrelative to controls"))

ggview(contrast_plot_turnover, units = "mm", width = column2x*0.66, height = column2x*0.5)
ggsave(file.path(path_name, "Fig6.png"), contrast_plot_turnover, width = column2x*0.66, height = column2x*0.5, units = "mm", bg = "white", device = "tiff", dpi = 600)
```

Fig. 5: Species and network-level specialization
```{r step7f, fig.width = 14, fig.height = 12}
...
contrast_plot_pollen_network <- contrasts_of_contrasts_df %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "yvar", shading = "below", text_size = size, title_size = title_size, point_size = shape_size, line_size = line_width) +
    ...
    annotate("text",  x = 2.2, y = 2.5, size = size*0.35, angle = 0, color = "black", label = c("Pre-to-post \nincrease in specialization \nrelative to controls")) +
    annotate("text",  x = 2.2, y = 0.4, size = size*0.35, angle = 0, color = "black", label = c("Pre-to-post \ndecrease in specialization \nrelative to controls"))

ggview(contrast_plot_pollen_network, units = "mm", width = column2x*0.66, height = column2x*0.5)
# ggsave(file.path(path_name, "test.png"), contrast_plot_pollen_network, width = column2x*0.66, height = column2x*0.5, units = "mm", bg = "white", device = "tiff", dpi = 600)
...
contrast_plot_camera_network <- contrasts_of_contrasts_df %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "yvar", shading = "below", text_size = size, title_size = title_size, point_size = shape_size, line_size = line_width) +
    ...
    annotate("segment", x = 1.72, xend = 1.72, y = 0.8, yend = 0.0, col = "black", linewidth = line_width*1.5, arrow = arrow(length = unit(0.3, "cm"))) +
    annotate("text",  x = 2.2, y = 1.6, size = size*0.35, angle = 0, color = "black", label = c("Pre-to-post \nincrease in specialization \nrelative to controls")) +
    annotate("text",  x = 2.2, y = 0.4, size = size*0.35, angle = 0, color = "black", label = c("Pre-to-post \ndecrease in specialization \nrelative to controls"))
...
#COMBINED PLOTS
#Get legend
legend <- get_legend(contrast_plot_individual + theme(legend.justification = "left"))
...
contrast_multiplot_species_network_with_legend <- ggarrange(contrast_multiplot_species_network, legend, nrow = 2, heights = c(0.98, 0.02))

ggview(contrast_multiplot_species_network_with_legend, units = "mm", width = column2x, height = column2x*0.9)
ggsave(file.path(path_name, "Fig5.png"), contrast_multiplot_species_network_with_legend, width = column2x, height = column2x*0.9, units = "mm", bg = "white", device = "tiff", dpi = 600)
```
