...
```{r step7b, message = FALSE, fig.width = 9, fig.height = 9}
...
ggview(turnover_multiplot, units = "in", width = 12, height = 6)
```
...
#Interaction plots
ggsave(file.path(path_name, "Interaction_multiplot_species_and_network_all.png"), interaction_multiplot_species_network_all, dpi = 600, units = "in", width = 9, height = 12, bg = "white")
ggsave(file.path(path_name, "Interaction_multiplot_species_and_network_gv.png"), interaction_multiplot_species_network_gv, dpi = 600, units = "in", width = 9, height = 9, bg = "white")
ggsave(file.path(path_name, "Interaction_multiplot_individual.png"), interaction_multiplot_individual, dpi = 600, units = "in", width = 9, height = 9, bg = "white")

#Contrast plots
ggsave(file.path(path_name, "Contrast_individual.png"), contrast_plot_individual, dpi = 600, units = "in", width = 10, height = 7, bg = "white")
ggsave(file.path(path_name, "Contrast_turnover.png"), contrast_plot_turnover, dpi = 600, units = "in", width = 10, height = 7, bg = "white")
ggsave(file.path(path_name, "Contrast_multiplot_species_and_network.png"), contrast_multiplot_species_network, dpi = 600, units = "in", width = 14, height = 12, bg = "white")
```