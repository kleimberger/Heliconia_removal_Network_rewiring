...
write.csv(emmeans, file.path(path_name,"Rewiring_results_emmeans.csv"), row.names = FALSE)
write.csv(contrasts, file.path(path_name,"Rewiring_results_contrasts.csv"), row.names = FALSE)
write.csv(contrasts_of_contrasts, file.path(path_name, "Rewiring_results_contrasts_of_contrasts.csv"), row.names = FALSE)
