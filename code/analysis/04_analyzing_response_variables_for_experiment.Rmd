...
walk2(assumption_checks$plotname2, assumption_checks$dharma_plot, ~ggsave(filename = .x, plot = .y, path = path_name, height = 11.5, width = 15, units = "in", bg = "white"))
...
column1x <- 80 #minimum width
column2x <- 180 #maximum width
...
contrast_plot_individual <- contrasts_of_contrasts_df %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "subanalysis", shading = "above", text_size = size, title_size = title_size, point_size = shape_size, line_size = line_width) +
    ...
    theme(plot.margin = unit(c(8, 48, 1, 1), "mm")) + #(top, right, bottom, left)
    theme(legend.box.spacing = unit(-2, "mm")) +
    annotation_custom(rasterGrob(pollen_icon, width = 0.4), xmin = 1, xmax = 2, ymin = 3.5*icon_y_scale, ymax = Inf) +
    annotate("segment", x = 2.8, xend = 2.8, y = 1.2, yend = 3.5, col = "black", linewidth = line_width*1.5, arrow = arrow(length = unit(0.3, "cm"))) +
    annotate("segment", x = 2.8, xend = 2.8, y = 0.8, yend = 0.0, col = "black", linewidth = line_width*1.5, arrow = arrow(length = unit(0.3, "cm"))) +
    annotate("text",  x = 3.5, y = 2.25, size = size*annotate_scale, angle = 0, color = "black", label = c("Pre-to-post \ndecrease in specialization \nrelative to controls")) +
    annotate("text",  x = 3.5, y = 0.4, size = size*annotate_scale, angle = 0, color = "black", label = c("Pre-to-post \nincrease in specialization \nrelative to controls"))

ggview(contrast_plot_individual, units = "mm", width = column2x*0.7, height = column2x*0.5)
ggsave(file.path(path_name, "Fig4.png"), contrast_plot_individual, width = column2x*0.7, height = column2x*0.5, units = "mm", bg = "white", device = "tiff", dpi = 600)
```
...
contrast_plot_turnover <- contrasts_of_contrasts_df %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "yvar", shading = "above", text_size = size, title_size = title_size, point_size = shape_size, line_size = line_width) +
    ...
    annotation_custom(rasterGrob(camera_icon, width = 0.3), xmin = 1, xmax = 3, ymin = 2.5*icon_y_scale, ymax = Inf) +
    annotate("segment", x = 3.9, xend = 3.9, y = 1.2, yend = 2.5, col = "black", linewidth = line_width*1.5, arrow = arrow(length = unit(0.3, "cm"))) +
    annotate("segment", x = 3.9, xend = 3.9, y = 0.8, yend = 0.0, col = "black", linewidth = line_width*1.5, arrow = arrow(length = unit(0.3, "cm"))) +
    annotate("text",  x = 4.8, y = 1.75, size = size*annotate_scale, angle = 0, color = "black", label = c("Increase in turnover \nrelative to controls")) +
    annotate("text",  x = 4.8, y = 0.4, size = size*annotate_scale, angle = 0, color = "black", label = c("Decrease in turnover \nrelative to controls"))

ggview(contrast_plot_turnover, units = "mm", width = column2x*0.7, height = column2x*0.5)
ggsave(file.path(path_name, "Fig6.png"), contrast_plot_turnover, width = column2x*0.7, height = column2x*0.5, units = "mm", bg = "white", device = "tiff", dpi = 600)
```
...
#RIGHT COLUMN: plots with explanatory arrows
...
contrast_plot_pollen_network <- contrasts_of_contrasts_df %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "yvar", shading = "below", text_size = size, title_size = title_size, point_size = shape_size, line_size = line_width) +
    ...
    annotation_custom(rasterGrob(pollen_icon, width = 0.25), xmin = 0.5, xmax = 1.5, ymin = 4*icon_y_scale, ymax = Inf) +
    annotate("segment", x = 1.72, xend = 1.72, y = 1.2, yend = 4.0, col = "black", linewidth = line_width*1.5, arrow = arrow(length = unit(0.3, "cm"))) +
    annotate("segment", x = 1.72, xend = 1.72, y = 0.8, yend = 0.0, col = "black", linewidth = line_width*1.5, arrow = arrow(length = unit(0.3, "cm"))) +
    annotate("text",  x = 2.19, y = 2.5, size = size*annotate_scale, angle = 0, color = "black", label = c("Pre-to-post \nincrease in specialization \nrelative to controls")) +
    annotate("text",  x = 2.19, y = 0.4, size = size*annotate_scale, angle = 0, color = "black", label = c("Pre-to-post \ndecrease in specialization \nrelative to controls"))

# ggview(contrast_plot_pollen_network, units = "mm", width = column2x*0.66, height = column2x*0.5)
...
contrast_plot_camera_network <- contrasts_of_contrasts_df %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "yvar", shading = "below", text_size = size, title_size = title_size, point_size = shape_size, line_size = line_width) +
    ...
    theme(plot.margin = unit(c(8, 48, 1, 1), "mm")) + #(top, right, bottom, left)
    theme(legend.position = "none") +
    annotation_custom(rasterGrob(camera_icon, width = 0.25), xmin = 0.5, xmax = 1.5, ymin = 2*icon_y_scale, ymax = Inf) +
    annotate("segment", x = 1.72, xend = 1.72, y = 1.2, yend = 2.0, col = "black", linewidth = line_width*1.5, arrow = arrow(length = unit(0.3, "cm"))) +
    annotate("segment", x = 1.72, xend = 1.72, y = 0.8, yend = 0.0, col = "black", linewidth = line_width*1.5, arrow = arrow(length = unit(0.3, "cm"))) +
    annotate("text",  x = 2.19, y = 1.6, size = size*annotate_scale, angle = 0, color = "black", label = c("Pre-to-post \nincrease in specialization \nrelative to controls")) +
    annotate("text",  x = 2.19, y = 0.4, size = size*annotate_scale, angle = 0, color = "black", label = c("Pre-to-post \ndecrease in specialization \nrelative to controls"))

# ggview(contrast_plot_camera_network, units = "mm", width = column2x*0.66, height = column2x*0.5)

#LEFT COLUMN: plots without explanatory arrows
...
contrast_plot_pollen_species <- contrasts_of_contrasts_df %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "yvar", shading = "below", text_size = size, title_size = title_size, point_size = shape_size, line_size = line_width) +
    ...
    theme(plot.title = element_text(hjust = 0.5, size = title_size)) +
    theme(plot.margin = unit(c(8, 1, 1, 1), "mm")) + #(top, right, bottom, left)
    theme(legend.position = "none") +
    annotation_custom(rasterGrob(pollen_icon, width = 0.25*1.66), xmin = 1, xmax = 2, ymin = 4*icon_y_scale, ymax = Inf) #Multiply by ggarrange widths to make icons the same size

# ggview(contrast_plot_pollen_species, units = "mm", width = column2x*0.33, height = column2x*0.5)
...
contrast_plot_camera_species <- contrasts_of_contrasts_df %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "yvar", shading = "below", text_size = size, title_size = title_size, point_size = shape_size, line_size = line_width) +
    ...
    theme(plot.margin = unit(c(8, 1, 1, 1), "mm")) + #(top, right, bottom, left)
    theme(legend.position = "none") +
    annotation_custom(rasterGrob(camera_icon, width = 0.25*1.66), xmin = 1, xmax = 2, ymin = 2*icon_y_scale, ymax = Inf) #Multiply by ggarrange widths to make icons the same size
  
# ggview(contrast_plot_camera_species, units = "mm", width = column2x*0.33, height = column2x*0.5)

#COMBINED PLOTS
#Get legend
legend <- get_legend(contrast_plot_individual + theme(legend.justification = "center"))
  
contrast_multiplot_species_network <- ggarrange(contrast_plot_pollen_species,
                                                contrast_plot_pollen_network,
                                                contrast_plot_camera_species,
                                                contrast_plot_camera_network,
                                                ncol = 2, nrow = 2, align = "h", labels = c("A", "B", "C", "D"),
                                                font.label = list(size = 12, face = "plain"),
                                                widths = c(1, 1.7))

ggview(contrast_multiplot_species_network, units = "mm", width = column2x, height = column2x)

contrast_multiplot_species_network_with_legend <- annotate_figure(contrast_multiplot_species_network, bottom = legend)
ggview(contrast_multiplot_species_network_with_legend, units = "mm", width = column2x, height = column2x)

ggsave(file.path(path_name, "Fig5.png"), contrast_multiplot_species_network_with_legend, width = column2x, height = column2x, units = "mm", bg = "white", device = "tiff", dpi = 600)
```

**Interaction plots** (specialization metrics only)

These plots are just for the Supporting information.
...
ggsave(file.path(path_name, "FigS3_Interaction_multiplot_individual.png"), interaction_multiplot_individual, units = "in", width = 9, height = 9, bg = "white", dpi = 600)
ggsave(file.path(path_name, "FigS4_Interaction_multiplot_species_network_all.png"), interaction_multiplot_species_network_all, units = "in", width = 9, height = 12, bg = "white", dpi = 600)
ggsave(file.path(path_name, "FigS5_Interaction_multiplot_species_network_gv.png"), interaction_multiplot_species_network_gv, units = "in", width = 9, height = 9, bg = "white", dpi = 600)
ggsave(file.path(path_name, "FigS6_Control_treatment_multiplot_turnover.png"), turnover_multiplot, units = "in", width = 11, height = 4.5, bg = "white", dpi = 600)
```
