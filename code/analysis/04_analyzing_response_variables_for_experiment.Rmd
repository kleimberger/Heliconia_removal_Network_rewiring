...
contrast_plot_turnover <- contrasts_of_contrasts_df %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "yvar", shading = "above", text_size = size, title_size = title_size, point_size = shape_size, line_size = line_width) +
    ...
    annotate("text",  x = 4.8, y = 1.75, size = size*annotate_scale, angle = 0, color = "black", label = c("Pre-to-post \nincrease in turnover \nrelative to controls")) +
    annotate("text",  x = 4.8, y = 0.4, size = size*annotate_scale, angle = 0, color = "black", label = c("Pre-to-post \ndecrease in turnover \nrelative to controls"))
