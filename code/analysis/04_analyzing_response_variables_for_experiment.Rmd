...
ggsave(file.path(path_name, "Fig4.png"), contrast_plot_individual, width = column2x*0.7, height = column2x*0.5, units = "mm", bg = "white", device = "tiff", dpi = 300)
```
...
ggsave(file.path(path_name, "Fig6.png"), contrast_plot_turnover, width = column2x*0.7, height = column2x*0.5, units = "mm", bg = "white", device = "tiff", dpi = 300)
```
...
ggsave(file.path(path_name, "Fig5.png"), contrast_multiplot_species_network_with_legend, width = column2x, height = column2x, units = "mm", bg = "white", device = "tiff", dpi = 300)
```
