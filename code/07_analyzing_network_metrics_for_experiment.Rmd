...
Individual specialization
```{r step5c, message = FALSE, warning = FALSE, fig.width = 10, fig.height = 7}
#INDIVIDUAL SPECIALIZATION
...
# ggview(units = "in", width = 10, height = 7)
```

Interaction turnover
```{r step5d, message = FALSE, warning = FALSE, fig.width = 10, fig.height = 7}
#INTERACTION TURNOVER
...
contrast_multiplot_species_network <- ggarrange(contrast_plot_pollen_species, contrast_plot_pollen_network, contrast_plot_camera_species, contrast_plot_camera_network,
                                                common.legend = TRUE, legend = "bottom", ncol = 2, nrow = 2, align = "h", labels = "AUTO", font.label = list(size = 24, face = "plain"), widths = c(1, 1.65))
...
#Contrast plots
ggsave(file.path(path_name, "Contrast_individual.png"), contrast_plot_individual, dpi = 300, units = "in", width = 10, height = 7, bg = "white")
ggsave(file.path(path_name, "Contrast_turnover.png"), contrast_plot_turnover, dpi = 300, units = "in", width = 10, height = 7, bg = "white")
