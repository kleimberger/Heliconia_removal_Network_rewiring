...
#3. Remove highly influential points (2016_60, 2018_60) - both of these networks have compartments of species entirely unconnected to rest of network
...
contrast_plot_camera_network <- contrasts_of_contrasts %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "yvar", shading = "below") +
    scale_x_discrete(labels = c(h2_label)) +
    scale_y_continuous(limits = c(0, 2.5), breaks = c(0, 0.5, 1, 2)) +
...
ggsave(file.path(path_name, "Contrast_multiplot.png"), contrast_multiplot_all_analyses, dpi = 300, units = "in", width = 9, height = 12, bg = "white")
```