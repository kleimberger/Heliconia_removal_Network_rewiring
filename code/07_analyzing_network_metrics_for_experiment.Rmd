...
contrast_plot_individual <- contrasts_of_contrasts %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "subanalysis", shading = "above") +
    ...
    theme(legend.position = "bottom",
          plot.margin = unit(c(1, 18, 0.5, 0.5), "lines")) + #Default plot margins in theme_bw are 1, 1, 0.5, 0.5 (top, right, bottom, left)
    ...
    annotate("text",  x = 3.5, y = 2.1, size = 6, angle = 0, color = "black", label = c("Pre-to-post \ndecrease in specialization \nrelative to controls")) +
...
Interaction turnover
```{r step5c, message = FALSE, warning = FALSE, fig.width = 9, fig.height = 12}
#INTERACTION TURNOVER
contrast_plot_turnover <- contrasts_of_contrasts %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "yvar", shading = "above") +
    ...
    annotate("text",  x = 4.75, y = 1.75, size = 6, angle = 0, color = "black", label = c("Pre-to-post \nincrease in turnover \nrelative to controls")) +
    annotate("text",  x = 4.75, y = 0.4, size = 6, angle = 0, color = "black", label = c("Pre-to-post \ndecrease in turnover \nrelative to controls"))
...
```{r step5d, message = FALSE, warning = FALSE, fig.width = 9, fig.height = 12}
...
contrast_plot_camera_network <- contrasts_of_contrasts %>%
  ...
  make_contrast_plot(contrasts_df = ., xvar = "yvar", shading = "below") +
    ...
    annotate("segment", x = 1.7, xend = 1.7, y = 0.8, yend = 0.0, col = "black", size = 1, arrow = arrow(length = unit(0.3, "cm"))) +
    annotate("text",  x = 2.18, y = 1.5, size = 6, angle = 0, color = "black", label = c("Pre-to-post \nincrease in specialization \nrelative to controls")) +
    annotate("text",  x = 2.18, y = 0.4, size = 6, angle = 0, color = "black", label = c("Pre-to-post \ndecrease in specialization \nrelative to controls"))
...
contrast_multiplot_species_network <- ggarrange(contrast_plot_pollen_species, contrast_plot_pollen_network, contrast_plot_camera_species, contrast_plot_camera_network,
                                                common.legend = TRUE, ncol = 2, nrow = 2, align = "h", legend = "bottom", labels = "AUTO", font.label = list(size = 20, face = "plain"), widths = c(1, 1.5))
...
#Contrast plots
ggsave(file.path(path_name, "Contrast_individual.png"), contrast_plot_individual, dpi = 300, units = "in", width = 9, height = 6, bg = "white")
ggsave(file.path(path_name, "Contrast_turnover.png"), contrast_plot_turnover, dpi = 300, units = "in", width = 9, height = 6, bg = "white")
