...
Want pollen and camera networks from the same time period, 'pre' only. Easiest to just use experiment data, subset to 'pre' period.
```{r step6}
...
Summarize data
```{r step7b, warning = FALSE, message = FALSE}
## Pre-post networks
...
write.csv(data_for_metanetwork, "../data/export/intermediate/Camera_data_filtered_for_metanetwork.csv") #'normal' visitation
write.csv(data_for_sampling_method, "../data/export/intermediate/Camera_data_filtered_for_sampling_method.csv")
