...
png("../results/analyses_experiment/interaction_turnover/figures/Toy_network_before_bw.png", width = 12, height = 10, res = 300, units = "in")
network_before
dev.off()
...
png("../results/analyses_experiment/interaction_turnover/figures/Toy_network_after_bw.png", width = 12, height = 10, res = 300, units = "in")
network_after
dev.off()
...
```{r}
webs_array <- bipartite::webs2array(before_matrix, after_matrix)
...
```{r}
colors <- c("#F0002C", "#4C49F2") #bright red, bright blue
...
plotweb(matrix_binary, method="normal", arrow="no",
        ...
        col.interaction = t(ifelse(matrix_coded[,] == 2, adjustcolor(colors[[1]], alpha.f = 0.5), #loss (species turnover)
                                   ifelse(matrix_coded[,] == 3,  adjustcolor(colors[[1]], alpha.f = 1), #gain (species turnover)
                                          ifelse(matrix_coded[,] == 4,  adjustcolor(colors[[2]], alpha.f = 0.5), #loss (rewiring)
                                                 ifelse(matrix_coded[,] == 5,  adjustcolor(colors[[2]], alpha.f = 1), "grey80")))))) #gain (rewiring)


network_WN <- recordPlot() #from package grDevices
png("../results/analyses_experiment/interaction_turnover/figures/Toy_network_WN_color_coded.png", width = 12, height = 10, res = 300, units = "in")
network_WN
dev.off()
```
...
plotweb(matrix_binary, method="normal", arrow="no",
        low.lablength=0, high.lablength=0,
        col.interaction = t(ifelse(matrix_coded[,] == 2, adjustcolor(colors[[1]], alpha.f = 0.5), #loss (species turnover)
                                   ifelse(matrix_coded[,] == 3,  adjustcolor(colors[[1]], alpha.f = 1), "grey80")))) #gain (species turnover)

network_ST <- recordPlot() #from package grDevices
png("../results/analyses_experiment/interaction_turnover/figures/Toy_network_ST_color_coded.png", width = 12, height = 10, res = 300, units = "in")
network_ST
dev.off()
```
...
plotweb(matrix_binary, method="normal", arrow="no",
        low.lablength=0, high.lablength=0,
        col.interaction = t(ifelse(matrix_coded[,] == 4, adjustcolor(colors[[2]], alpha.f = 0.5), #loss (rewiring)
                                   ifelse(matrix_coded[,] == 5,  adjustcolor(colors[[2]], alpha.f = 1), "grey80")))) #gain (rewiring)
 
network_OS <- recordPlot() #from package grDevices
png("../results/analyses_experiment/interaction_turnover/figures/Toy_network_OS_color_coded.png", width = 12, height = 10, res = 300, units = "in")
network_OS
dev.off()
```
