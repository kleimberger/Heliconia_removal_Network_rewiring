...
write.csv(results_tidy_confint, "../results/analyses_sampling_method/tables/Summary_tables.csv") #model summaries
...
ggsave("../results/analyses_sampling_method/figures/Specialization_density_plot.png", specialization_density_plot, dpi = 300, units = "in", width = 9, height = 5)
ggsave("../results/analyses_sampling_method/figures/Specialization_results_multiplot.png", specialization_results_multiplot, dpi = 300, units = "in", width = 4, height = 11)

#Q2
ggsave("../results/analyses_sampling_method/figures/Correlation_results_multipplot.png", correlation_results_multiplot, dpi = 300, units = "in", width = 4, height = 11)
```