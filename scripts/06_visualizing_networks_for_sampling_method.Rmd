...
bipartite::plotweb(pollen_matrix, method = "cca", arrow = "no",
                   ...
                   y.lim = c(-0.75, 2.75),
                   x.lim = c(0, 1.75),
                   col.low = ifelse(rownames(pollen_matrix) == "Heliconia", "#BA0022", "grey10"),
                   bor.col.low = NA,
                   col.interaction = t(ifelse(pollen_matrix[,] > 0 & rownames(pollen_matrix) == "Heliconia", "#BA0022", "grey80")),
                   bor.col.interaction = t(ifelse(pollen_matrix[,] > 0 & rownames(pollen_matrix) == "Heliconia", "#BA0022", "black")))
...
bipartite::plotweb(camera_matrix, method = "cca", arrow = "no",
                   ...
                   y.lim = c(-0.75, 2.75),
                   x.lim = c(0, 1.75),
                   col.low = ifelse(rownames(camera_matrix) == "Heliconia", "#BA0022", "grey10"),
                   bor.col.low = NA,
                   col.interaction = t(ifelse(camera_matrix[,] > 0 & rownames(camera_matrix) == "Heliconia", "#BA0022", "grey80")),
                   bor.col.interaction = t(ifelse(camera_matrix[,] > 0 & rownames(camera_matrix) == "Heliconia", "#BA0022", "black")))
