...
pollen_network <- recordPlot() #from package grDevices
png("../results/network_visualizations/metanetworks/Pollen_metanetwork.png", width = 12, height = 10, res = 300, units = "in")
pollen_network
dev.off()
```
...
camera_network <- recordPlot() #from package grDevices
png("../results/network_visualizations/metanetworks/Camera_metanetwork.png", width = 12, height = 10, res = 300, units = "in")
camera_network
dev.off()
```