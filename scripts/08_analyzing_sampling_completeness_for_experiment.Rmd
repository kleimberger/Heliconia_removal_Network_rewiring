...
```{r step5}
write.csv(completeness_sum, "../results/analyses_experiment/tables/Sampling_completeness_summary.csv")
write.csv(completeness_contrasts, "../results/analyses_experiment/tables/Sampling_completeness_contrasts.csv")
ggsave("../results/analyses_experiment/figures/Sampling_completeness_plot.png", plot = chao1_plot, width = 7, height = 7, units = "in", dpi = 300)
```
