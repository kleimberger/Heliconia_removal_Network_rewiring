...
1. Sampling completeness was higher for visitation networks, which were sampled through an array of trail cameras.
2. For pollen networks, pre-to-post sampling completeness was lower in treatment replicates than in control replicates, introducing systematic sampling bias. **Therefore, for the analysis of interaction turnover, I will only analyze visitation networks.**
...
completeness_contrasts <- tibble(model_number = c(1, 2, 3),
                                 model_name = c("Pollen", "Visitation", "Visitation (without outliers)"),
...
```{r step5}
path_name <- c("../results/analyses_experiment/interaction_turnover")
write.csv(completeness_sum, file.path(path_name, "tables/Sampling_completeness_summary.csv"))
write.csv(completeness_contrasts, file.path(path_name, "tables/Sampling_completeness_contrasts.csv"))
